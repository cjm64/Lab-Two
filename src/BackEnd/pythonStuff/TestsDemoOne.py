...
import BackEnd.pythonStuff.Main
...
class MyTestCase(unittest.TestCase):
    ...
    def test_hitDetection(self):
        ...
        case1 = BackEnd.pythonStuff.OurClasses.thing(10, 10) # x and y
        case1.sizeX = 4
        case1.sizeY = 4

        case1p = BackEnd.pythonStuff.OurClasses.thing(8, 15) # this position is outside of the player's range
        case1p.sizeX = 3 # this puts it in x range
        case1p.sizeY = 10 # below the player

        case2 = BackEnd.pythonStuff.OurClasses.thing(4, 3)
        case2.sizeX = 6
        case2.sizeY = 2

        case2p = BackEnd.pythonStuff.OurClasses.thing(9, 1)
        case2p.sizeX = 5
        case2p.sizeY = 1

        case3 = BackEnd.pythonStuff.OurClasses.thing(31, 28)
        case3.sizeX = 4
        case3.sizeY = 2

        case3p = BackEnd.pythonStuff.OurClasses.thing(33, 31)
        case3p.sizeX = 20
        case3p.sizeY = 15

        case4 = BackEnd.pythonStuff.OurClasses.thing(10, 15)
        case4.sizeX = 10
        case4.sizeY = 5

        case4p = BackEnd.pythonStuff.OurClasses.thing(5, 5)
        case4p.sizeX = 10
        case4p.sizeY = 4

        case5 = BackEnd.pythonStuff.OurClasses.thing(8, 10)
        case5.sizeX = 30
        case5.sizeY = 6

        case5p = BackEnd.pythonStuff.OurClasses.thing(10, 5)
        case5p.sizeX = 2
        case5p.sizeY = 8

        case6 = BackEnd.pythonStuff.OurClasses.thing(20, 20)
        case6.sizeX = 5
        case6.sizeY = 10

        case6p = BackEnd.pythonStuff.OurClasses.thing(18, 25)
        case6p.sizeX = 4
        case6p.sizeY = 10

        case7 = BackEnd.pythonStuff.OurClasses.thing(30, 30)
        case7.sizeX = 20
        case7.sizeY = 20

        case7p = BackEnd.pythonStuff.OurClasses.thing(40, 40)
        case7p.sizeX = 5
        case7p.sizeY = 5

        case8 = BackEnd.pythonStuff.OurClasses.thing(5, 5)
        case8.sizeX = 5
        case8.sizeY = 5

        case8p = BackEnd.pythonStuff.OurClasses.thing(15, 5)
        case8p.sizeX = 5
        case8p.sizeY = 5
    ...
    def test_offMapDetection(self):
        ...
        case1 = BackEnd.pythonStuff.OurClasses.thing(-2, 400)
        case2 = BackEnd.pythonStuff.OurClasses.thing(1000, 400)
        case3 = BackEnd.pythonStuff.OurClasses.thing(400, -40)
        case4 = BackEnd.pythonStuff.OurClasses.thing(400, 1500)
        case5 = BackEnd.pythonStuff.OurClasses.thing(-1000, -1000)
        case6 = BackEnd.pythonStuff.OurClasses.thing(1000, 1000)
        case7 = BackEnd.pythonStuff.OurClasses.thing(0, 0) # false
        case8 = BackEnd.pythonStuff.OurClasses.thing(800, 800)
        case9 = BackEnd.pythonStuff.OurClasses.thing(800, 400)
        case10 = BackEnd.pythonStuff.OurClasses.thing(400, 400)
    ...
    def test_UpdatePosition(self):
        ...
        testThing = BackEnd.pythonStuff.OurClasses.thing(80000, 800000)
    ...
    def test_createNewPlayer(self):
        ...
        location1 = BackEnd.pythonStuff.OurClasses.thing(40, 21)
        name1 = "newPlayer"

        location2 = BackEnd.pythonStuff.OurClasses.thing(33, 77)
        name2 = "Godzilla"

        location3 = BackEnd.pythonStuff.OurClasses.thing(90, 32)
        name3 = "Jake"
